...
# tcp supported = 1019 = 0x03fb => 0xfb03 (LE byte order)
sudo nft add rule inet filter output udp sport $port @ih,16,16 0xfb03 log
sudo nft add rule inet filter output udp sport $port @ih,16,16 0xfb03 drop
