...
# server list = 1006 = 0x03ee => 0xee03 (LE byte order)
sudo nft add rule inet filter output udp sport $port @ih,16,16 0xfa03 log
sudo nft add rule inet filter output udp sport $port @ih,16,16 0xfa03 drop
